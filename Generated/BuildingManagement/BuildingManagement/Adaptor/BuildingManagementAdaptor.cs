    ...
    public class BuildingManagementAdaptor : DomainModelAdaptor
    {
        ...
        public static DomainModelAdaptor GetInstance(Logger logger)
        {
            if (adapterInstance == null)
            {
                ...
                var azureDigitalTwinsAdaptor = new BuildingManagementAzureDigitalTwinsAdaptor((string)Configuration["ADTInstanceUri"], (TokenCredential)Configuration["ADTCredential"], instanceRepository, logger);
